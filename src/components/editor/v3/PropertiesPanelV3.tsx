...
import {
  ...
  FormularioSections, FaqSections, TimerSections,
...
function renderSections(
  ...
  switch (el.type) {
    ...
    case 'timer':
      return <TimerSections el={el} onChange={onChange as (p: Partial<Elem>) => void} />
    default:
      return null
  }
}
...
function typeLabel(type: Elem['type']): string {
  const labels: Record<Elem['type'], string> = {
    ...
    formulario: 'Formulário', faq: 'FAQ', timer: 'Timer',
  }
