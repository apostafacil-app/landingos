...
const BLOCK_ICONS: Record<string, string> = {
  ...
  'hero-com-video': `<svg viewBox="0 0 120 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="120" height="72" rx="4" fill="#f8fafc"/><rect x="30" y="8" width="60" height="5" rx="2" fill="#1e293b"/><rect x="42" y="17" width="36" height="3" rx="1.5" fill="#94a3b8"/><rect x="20" y="26" width="80" height="34" rx="4" fill="#1e293b"/><circle cx="60" cy="43" r="9" fill="#ff0000" opacity=".9"/><polygon points="56,37 56,49 67,43" fill="white"/><rect x="44" y="64" width="32" height="6" rx="3" fill="#2563eb"/></svg>`,
  'hero-minimalista': `<svg viewBox="0 0 120 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="120" height="72" rx="4" fill="white"/><rect x="14" y="22" width="92" height="11" rx="2" fill="#0f172a"/><rect x="30" y="38" width="60" height="4" rx="2" fill="#64748b" opacity=".7"/><rect x="46" y="50" width="28" height="10" rx="2" fill="#0f172a"/></svg>`,
  // ── Benefícios ────────────────────────────────────────────────
  ...
  'depoimentos-2-vertical': `<svg viewBox="0 0 120 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="120" height="72" rx="4" fill="white"/><rect x="6" y="10" width="52" height="52" rx="6" fill="#f8fafc"/><text x="12" y="24" fill="#f59e0b" font-size="9">★★★★★</text><rect x="12" y="30" width="40" height="3" rx="1.5" fill="#94a3b8"/><rect x="12" y="36" width="36" height="3" rx="1.5" fill="#94a3b8"/><rect x="12" y="42" width="32" height="3" rx="1.5" fill="#94a3b8"/><circle cx="18" cy="55" r="4" fill="#cbd5e1"/><rect x="26" y="53" width="22" height="3" rx="1.5" fill="#1e293b"/><rect x="62" y="10" width="52" height="52" rx="6" fill="#f8fafc"/><text x="68" y="24" fill="#f59e0b" font-size="9">★★★★★</text><rect x="68" y="30" width="40" height="3" rx="1.5" fill="#94a3b8"/><rect x="68" y="36" width="36" height="3" rx="1.5" fill="#94a3b8"/><rect x="68" y="42" width="32" height="3" rx="1.5" fill="#94a3b8"/><circle cx="74" cy="55" r="4" fill="#cbd5e1"/><rect x="82" y="53" width="22" height="3" rx="1.5" fill="#1e293b"/></svg>`,
  'depoimentos-logos': `<svg viewBox="0 0 120 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="120" height="72" rx="4" fill="#f8fafc"/><rect x="20" y="10" width="80" height="4" rx="2" fill="#94a3b8"/><rect x="6" y="22" width="20" height="20" rx="3" fill="#e2e8f0"/><rect x="30" y="22" width="20" height="20" rx="3" fill="#e2e8f0"/><rect x="54" y="22" width="20" height="20" rx="3" fill="#e2e8f0"/><rect x="78" y="22" width="20" height="20" rx="3" fill="#e2e8f0"/><rect x="100" y="22" width="14" height="20" rx="3" fill="#e2e8f0"/><rect x="36" y="52" width="48" height="3" rx="1.5" fill="#cbd5e1"/></svg>`,
  'depoimento-video': `<svg viewBox="0 0 120 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="120" height="72" rx="4" fill="white"/><rect x="20" y="6" width="80" height="3" rx="1.5" fill="#2563eb"/><rect x="14" y="13" width="92" height="5" rx="2" fill="#1e293b"/><rect x="6" y="24" width="108" height="42" rx="6" fill="#1e293b"/><circle cx="60" cy="45" r="11" fill="#ff0000" opacity=".9"/><polygon points="56,38 56,52 68,45" fill="white"/></svg>`,
  // ── Estatísticas ──────────────────────────────────────────────
  ...
  'formulario-contato': `<svg viewBox="0 0 120 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="120" height="72" rx="4" fill="white"/><rect x="6" y="8" width="40" height="5" rx="2" fill="#1e293b"/><circle cx="12" cy="22" r="4" fill="#eff6ff"/><rect x="20" y="20" width="28" height="3" rx="1.5" fill="#64748b"/><rect x="20" y="26" width="22" height="2" rx="1" fill="#94a3b8"/><circle cx="12" cy="38" r="4" fill="#eff6ff"/><rect x="20" y="36" width="28" height="3" rx="1.5" fill="#64748b"/><rect x="20" y="42" width="22" height="2" rx="1" fill="#94a3b8"/><circle cx="12" cy="54" r="4" fill="#eff6ff"/><rect x="20" y="52" width="28" height="3" rx="1.5" fill="#64748b"/><rect x="56" y="8" width="58" height="56" rx="6" fill="#f8fafc"/><rect x="62" y="14" width="46" height="7" rx="2" stroke="#e2e8f0" stroke-width="1" fill="white"/><rect x="62" y="24" width="46" height="7" rx="2" stroke="#e2e8f0" stroke-width="1" fill="white"/><rect x="62" y="34" width="46" height="20" rx="2" stroke="#e2e8f0" stroke-width="1" fill="white"/><rect x="62" y="56" width="46" height="6" rx="3" fill="#0f172a"/></svg>`,
  // ── CTA ───────────────────────────────────────────────────────
  ...
  'faq-2-colunas': `<svg viewBox="0 0 120 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="120" height="72" rx="4" fill="#f8fafc"/><rect x="30" y="6" width="60" height="4" rx="2" fill="#1e293b"/><rect x="6" y="14" width="52" height="14" rx="3" fill="white" stroke="#e2e8f0" stroke-width="1"/><rect x="10" y="18" width="40" height="3" rx="1.5" fill="#1e293b"/><rect x="10" y="23" width="32" height="2" rx="1" fill="#94a3b8"/><rect x="6" y="32" width="52" height="14" rx="3" fill="white" stroke="#e2e8f0" stroke-width="1"/><rect x="10" y="36" width="40" height="3" rx="1.5" fill="#1e293b"/><rect x="10" y="41" width="32" height="2" rx="1" fill="#94a3b8"/><rect x="6" y="50" width="52" height="14" rx="3" fill="white" stroke="#e2e8f0" stroke-width="1"/><rect x="10" y="54" width="40" height="3" rx="1.5" fill="#1e293b"/><rect x="10" y="59" width="32" height="2" rx="1" fill="#94a3b8"/><rect x="62" y="14" width="52" height="14" rx="3" fill="white" stroke="#e2e8f0" stroke-width="1"/><rect x="66" y="18" width="40" height="3" rx="1.5" fill="#1e293b"/><rect x="66" y="23" width="32" height="2" rx="1" fill="#94a3b8"/><rect x="62" y="32" width="52" height="14" rx="3" fill="white" stroke="#e2e8f0" stroke-width="1"/><rect x="66" y="36" width="40" height="3" rx="1.5" fill="#1e293b"/><rect x="66" y="41" width="32" height="2" rx="1" fill="#94a3b8"/><rect x="62" y="50" width="52" height="14" rx="3" fill="white" stroke="#e2e8f0" stroke-width="1"/><rect x="66" y="54" width="40" height="3" rx="1.5" fill="#1e293b"/><rect x="66" y="59" width="32" height="2" rx="1" fill="#94a3b8"/></svg>`,
  // ── Vídeo ─────────────────────────────────────────────────────
  ...
  'garantia-7dias': `<svg viewBox="0 0 120 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="120" height="72" rx="4" fill="white"/><circle cx="60" cy="36" r="22" fill="#eff6ff" stroke="#2563eb" stroke-width="2"/><text x="60" y="34" text-anchor="middle" fill="#2563eb" font-size="14" font-weight="bold">7</text><text x="60" y="44" text-anchor="middle" fill="#2563eb" font-size="6">DIAS</text></svg>`,
  'garantia-selo-lateral': `<svg viewBox="0 0 120 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="120" height="72" rx="4" fill="#f8fafc"/><rect x="8" y="14" width="38" height="44" rx="6" fill="#dbeafe"/><path d="M27 22 L37 26 L37 40 Q37 50 27 54 Q17 50 17 40 L17 26 Z" fill="none" stroke="#2563eb" stroke-width="1.5"/><text x="27" y="42" text-anchor="middle" fill="#2563eb" font-size="11">✓</text><rect x="54" y="20" width="58" height="5" rx="2" fill="#1e293b"/><rect x="54" y="32" width="50" height="3" rx="2" fill="#94a3b8"/><rect x="54" y="40" width="48" height="3" rx="2" fill="#94a3b8"/><rect x="54" y="48" width="42" height="3" rx="2" fill="#94a3b8"/></svg>`,
  'garantia-checklist': `<svg viewBox="0 0 120 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="120" height="72" rx="4" fill="white"/><circle cx="26" cy="36" r="20" fill="#dcfce7" stroke="#16a34a" stroke-width="2"/><text x="26" y="34" text-anchor="middle" fill="#16a34a" font-size="10" font-weight="bold">30</text><text x="26" y="44" text-anchor="middle" fill="#16a34a" font-size="5">DIAS</text><circle cx="58" cy="18" r="3" fill="#dcfce7"/><text x="58" y="20.5" text-anchor="middle" fill="#16a34a" font-size="5">✓</text><rect x="66" y="16" width="46" height="3" rx="1.5" fill="#1e293b"/><circle cx="58" cy="32" r="3" fill="#dcfce7"/><text x="58" y="34.5" text-anchor="middle" fill="#16a34a" font-size="5">✓</text><rect x="66" y="30" width="44" height="3" rx="1.5" fill="#1e293b"/><circle cx="58" cy="46" r="3" fill="#dcfce7"/><text x="58" y="48.5" text-anchor="middle" fill="#16a34a" font-size="5">✓</text><rect x="66" y="44" width="42" height="3" rx="1.5" fill="#1e293b"/><circle cx="58" cy="60" r="3" fill="#dcfce7"/><text x="58" y="62.5" text-anchor="middle" fill="#16a34a" font-size="5">✓</text><rect x="66" y="58" width="40" height="3" rx="1.5" fill="#1e293b"/></svg>`,
  'garantia-tripla': `<svg viewBox="0 0 120 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="120" height="72" rx="4" fill="#f8fafc"/><rect x="6" y="18" width="34" height="44" rx="4" fill="white" stroke="#e2e8f0" stroke-width="1"/><circle cx="23" cy="32" r="8" fill="#eff6ff" stroke="#2563eb" stroke-width="1.5"/><text x="23" y="34" text-anchor="middle" fill="#2563eb" font-size="6" font-weight="bold">7d</text><rect x="11" y="46" width="24" height="3" rx="1.5" fill="#94a3b8"/><rect x="14" y="52" width="18" height="2" rx="1" fill="#cbd5e1"/><rect x="43" y="18" width="34" height="44" rx="4" fill="white" stroke="#e2e8f0" stroke-width="1"/><circle cx="60" cy="32" r="8" fill="#dcfce7" stroke="#16a34a" stroke-width="1.5"/><text x="60" y="34" text-anchor="middle" fill="#16a34a" font-size="6" font-weight="bold">30d</text><rect x="48" y="46" width="24" height="3" rx="1.5" fill="#94a3b8"/><rect x="51" y="52" width="18" height="2" rx="1" fill="#cbd5e1"/><rect x="80" y="18" width="34" height="44" rx="4" fill="white" stroke="#e2e8f0" stroke-width="1"/><circle cx="97" cy="32" r="8" fill="#fffbeb" stroke="#f59e0b" stroke-width="1.5"/><text x="97" y="34" text-anchor="middle" fill="#f59e0b" font-size="6" font-weight="bold">12m</text><rect x="85" y="46" width="24" height="3" rx="1.5" fill="#94a3b8"/><rect x="88" y="52" width="18" height="2" rx="1" fill="#cbd5e1"/></svg>`,
  'garantia-strip': `<svg viewBox="0 0 120 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="120" height="72" rx="4" fill="#f0fdf4"/><rect x="6" y="22" width="108" height="28" rx="6" fill="white" stroke="#bbf7d0" stroke-width="1"/><circle cx="20" cy="36" r="8" fill="#dcfce7"/><text x="20" y="39" text-anchor="middle" fill="#16a34a" font-size="9">✓</text><rect x="34" y="29" width="60" height="4" rx="2" fill="#1e293b"/><rect x="34" y="38" width="48" height="3" rx="2" fill="#94a3b8"/></svg>`,
  'garantia-premium': `<svg viewBox="0 0 120 72" fill="none" xmlns="http://www.w3.org/2000/svg"><rect width="120" height="72" rx="4" fill="#0f172a"/><circle cx="60" cy="32" r="20" fill="#1e293b" stroke="#fbbf24" stroke-width="2"/><text x="60" y="30" text-anchor="middle" fill="#fbbf24" font-size="11" font-weight="bold">30</text><text x="60" y="40" text-anchor="middle" fill="#fbbf24" font-size="5">DIAS</text><rect x="30" y="58" width="60" height="3" rx="1.5" fill="#fbbf24" opacity=".7"/><rect x="40" y="64" width="40" height="2" rx="1" fill="#475569"/></svg>`,
  // ── Logos ─────────────────────────────────────────────────────
